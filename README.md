...
5.Also in terminal, run `pakku fetch` to download existing mods in repo from pakku manifest. If pakku is not locally installed use `java -jar pakku.jar fetch` instead
